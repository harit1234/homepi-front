...
export class HcComponent {
  ...
  switchon(){
    this._http.post('192.168.1.5:3000', {buttonStatus : 'true'},{headers:this.headers.set('token',this.kp.token)})
  }
  switchoff(){
    this._http.post('192.168.1.5:3000', {buttonStatus : 'false'},{headers:this.headers.set('token',this.kp.token)})
  }
